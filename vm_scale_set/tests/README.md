...
| <a name="input_source_image_name"></a> [source\_image\_name](#input\_source\_image\_name) | n/a | `string` | `"ubuntu2204-image-v1"` | no |
| <a name="input_subnet_cidr_vmss"></a> [subnet\_cidr\_vmss](#input\_subnet\_cidr\_vmss) | n/a | `list(string)` | <pre>[<br/>  "10.0.1.0/26"<br/>]</pre> | no |
