...
module "subnet_vmss" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//subnet?ref=v8.16.0"
...
module "load_balancer" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//load_balancer?ref=v8.16.0"
...
module "vmss" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//vm_scale_set?ref=v8.16.0"
