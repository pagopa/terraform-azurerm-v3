...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_web_app_service_docker"></a> [web\_app\_service\_docker](#module\_web\_app\_service\_docker) | ../../app_service | n/a |
| <a name="module_web_app_service_slot_docker"></a> [web\_app\_service\_slot\_docker](#module\_web\_app\_service\_slot\_docker) | ../ | n/a |
...
| <a name="input_vnet_address_space"></a> [vnet\_address\_space](#input\_vnet\_address\_space) | ## Custom variables | `list(string)` | <pre>[<br/>  "10.0.0.0/16"<br/>]</pre> | no |
