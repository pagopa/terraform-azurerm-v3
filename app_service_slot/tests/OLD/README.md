...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_web_app_service_docker"></a> [web\_app\_service\_docker](#module\_web\_app\_service\_docker) | git::https://github.com/pagopa/terraform-azurerm-v3.git//app_service | v8.16.0 |
| <a name="module_web_app_service_slot_docker"></a> [web\_app\_service\_slot\_docker](#module\_web\_app\_service\_slot\_docker) | git::https://github.com/pagopa/terraform-azurerm-v3.git//app_service_slot | v8.16.0 |
