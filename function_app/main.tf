...
module "storage_account" {
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//storage_account?ref=v4.0.0"
...
module "storage_account_durable_function_management_policy" {
  ...
  source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//storage_management_policy?ref=v4.0.0"
