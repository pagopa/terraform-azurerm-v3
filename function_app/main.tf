...
module "storage_account_durable_function" {
  ...
  account_kind                  = var.durable_storage_account_info ? var.durable_storage_account_info.account_kind : var.storage_account_info.account_kind
  account_tier                  = var.durable_storage_account_info ? var.durable_storage_account_info.account_tier : var.storage_account_info.account_tier
  account_replication_type      = var.durable_storage_account_info ? var.durable_storage_account_info.account_replication_type : var.storage_account_info.account_replication_type
  access_tier                   = var.durable_storage_account_info ? var.durable_storage_account_info.account_kind != "Storage" ? var.durable_storage_account_info.access_tier : null : var.storage_account_info.account_kind != "Storage" ? var.storage_account_info.access_tier : null
  resource_group_name           = var.resource_group_name
  location                      = var.location
