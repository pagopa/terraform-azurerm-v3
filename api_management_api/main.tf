...
# retrieves the api operation id only if is_soap, because it is generated by the API Management service
# returns a map with the soap action as key and the operation id as value
